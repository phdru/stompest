# -*- coding: utf-8 -*-
#
# stompest documentation build configuration file, created by
# sphinx-quickstart on Tue Nov  6 22:34:53 2012.
#
...
version = stompest.VERSION
# The full version, including alpha/beta/rc tags.
release = stompest.FULL_VERSION
...
# documentation.
html_theme_options = {'sidebarwidth': 210}
...
html_title = '%s documentation - v%s' % (project, release)
...
man_pages = [
    ('index', 'stompest', 'stompest Documentation',
     ['Jan Müller, Roger Hoover'], 1)
]
...
texinfo_documents = [
  ('index', 'stompest', 'stompest Documentation',
   'Jan Müller, Roger Hoover', 'stompest', 'STOMP bindings for Python 2.7 and higher',
   'Messaging'),
]
